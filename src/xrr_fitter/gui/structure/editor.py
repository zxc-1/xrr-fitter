...
class StructureEditor(QWidget):
    ...
    def _build_widgets(self) -> None:
        ...
        toolbar_row.setSpacing(theme.SPACE_XS)
        toolbar_row.addWidget(self.add_layer_button)
        toolbar_row.addWidget(self.add_periodic_button)
        toolbar_row.addWidget(self.edit_backing_button)
        toolbar_row.addWidget(self.remove_button)
        toolbar_row.addWidget(self.up_button)
        toolbar_row.addWidget(self.down_button)
