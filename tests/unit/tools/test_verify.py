...
def test_registry_commands_are_exact_for_completed_suites(load_tool_module) -> None:
    ...
    expected_unit = (
        ...
        + (
            ...
            "tests/unit/test_evaluation_instrument_jacobian.py",
            "tests/unit/test_evaluation_prior_extremes.py",
            "tests/unit/test_evaluation_prior_mapping.py",
            "tests/unit/test_evaluation_priors.py",
            "tests/unit/test_evaluation_resolution_qz.py",
            "tests/unit/test_evaluation_solver_loss.py",
            "tests/unit/test_evaluation_solver_system.py",
            "tests/unit/test_evaluation_transitions.py",
            "tests/unit/fit",
            "tests/unit/analysis",
            "tests/unit/services",
            "tests/unit/cli",
    ...
    expected_regression = (
        ...
        + (
            ...
            "tests/regression/test_poisson_local_precision.py",
            "tests/regression/test_poisson_two_stage_refit.py",
    ...
    expected_integration = (
        ...
        + (
            ...
            "tests/integration/test_export_parameter_members.py",
            "tests/integration/test_locked_fit_workflow.py",
